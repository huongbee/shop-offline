    ...
    <div class="tp-banner">
      <ul>
        ...
        <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700">
          ...
          <!-- LAYERS -->
          <!-- LAYER NR. 1 -->
          <div class="tp-caption very_big_white skewfromrightshort fadeout" data-x="center" data-y="100" data-speed="500" data-start="1200" data-easing="Circ.easeInOut" style=" font-size:70px; font-weight:800; color:#fe0100;">Huge
                ...
                <div class="slider-items-products">
                  <div id="featured-slider" class="product-flexslider hidden-buttons">
                    <div class="slider-items slider-width-col4">
                      <?php
                      foreach ($data['featuredProducts'] as $value) :
                        ?>
                            ...
                            <div class="product-thumbnail">
                              ...
                              <div class="pr-img-area">
                                <a title="Ipsums Dolors Untra" href="single_product.html">
                                  <figure>
                                    <img class="first-img" src="public/source/products-images/<?= $value->image ?>" alt="html template">
                                    <img class="hover-img" src="public/source/products-images/<?= $value->image ?>" alt="html template">
                                  </figure>
                                </a>
                                <button type="button" class="add-to-cart-mt" data-id="<?= $value->id ?>" <i class="fa fa-shopping-cart"></i>
